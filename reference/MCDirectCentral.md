# Monte Carlo Sampling Distribution of Direct Effect Centrality Over a Specific Time Interval or a Range of Time Intervals

This function generates a Monte Carlo method sampling distribution of
the direct effect centrality at a particular time interval \\\Delta t\\
...
- thetahatstar:
  ...
  A matrix of Monte Carlo direct effect centrality.
...
#> Call:
#> MCDirectCentral(phi = phi, vcov_phi_vec = vcov_phi_vec, delta_t = 1, 
#>     R = 100L)
#> 
#> Direct Effect Centrality
#>   variable interval     est     se   R    2.5%   97.5%
#> 1        x        1  0.3998 0.0356 100  0.3283  0.4635
#> 2        m        1 -0.2675 0.0528 100 -0.3643 -0.1698
#> 3        y        1  0.5000 0.0536 100  0.4025  0.5946
...
# Methods -------------------------------------------------------------------
# MCDirectCentral has a number of methods including
# print, summary, confint, and plot
print(mc)
#> Call:
#> MCDirectCentral(phi = phi, vcov_phi_vec = vcov_phi_vec, delta_t = 1:5, 
#>     R = 100L)
#> 
#> Direct Effect Centrality
#>    variable interval     est     se   R    2.5%   97.5%
#> 1         x        1  0.3998 0.0334 100  0.3319  0.4637
#> 2         m        1 -0.2675 0.0488 100 -0.3788 -0.1679
#> 3         y        1  0.5000 0.0422 100  0.4216  0.5647
#> 4         x        2  0.4398 0.0375 100  0.3665  0.5124
#> 5         m        2 -0.3209 0.0629 100 -0.4722 -0.2019
#> 6         y        2  0.6499 0.0584 100  0.5465  0.7575
#> 7         x        3  0.3638 0.0379 100  0.3085  0.4346
#> 8         m        3 -0.2914 0.0668 100 -0.4487 -0.1767
#> 9         y        3  0.6347 0.0749 100  0.5120  0.7905
#> 10        x        4  0.2683 0.0366 100  0.2169  0.3367
#> 11        m        4 -0.2374 0.0662 100 -0.3846 -0.1334
#> 12        y        4  0.5521 0.0888 100  0.4075  0.7518
#> 13        x        5  0.1859 0.0333 100  0.1408  0.2495
#> 14        m        5 -0.1828 0.0627 100 -0.3156 -0.0952
#> 15        y        5  0.4511 0.0975 100  0.2970  0.6794
summary(mc)
#> Call:
#> MCDirectCentral(phi = phi, vcov_phi_vec = vcov_phi_vec, delta_t = 1:5, 
#>     R = 100L)
...
#> 1         x        1  0.3318839  0.46374972
#> 2         m        1 -0.3788381 -0.16789799
#> 3         y        1  0.4215817  0.56465647
#> 4         x        2  0.3665149  0.51235360
#> 5         m        2 -0.4722173 -0.20189629
#> 6         y        2  0.5464522  0.75752309
#> 7         x        3  0.3084842  0.43462025
#> 8         m        3 -0.4486926 -0.17672780
#> 9         y        3  0.5120108  0.79045841
#> 10        x        4  0.2168736  0.33671780
#> 11        m        4 -0.3845916 -0.13343874
#> 12        y        4  0.4074933  0.75178353
#> 13        x        5  0.1408380  0.24951903
#> 14        m        5 -0.3155632 -0.09519621
#> 15        y        5  0.2969876  0.67942408
plot(mc)
