...
This function generates a bootstrap method sampling distribution of the
standardized total, direct and indirect effects of the independent
...
- thetahatstar:
  ...
  A matrix of bootstrap standardized total, direct, and indirect
  effects.
