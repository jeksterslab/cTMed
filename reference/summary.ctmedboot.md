...
summary(object, alpha = 0.05, type = "pc", digits = 4, ...)
```
...
Returns a data frame of effects, time intervals, estimates, standard
errors, number of bootstrap replications, and confidence intervals.
