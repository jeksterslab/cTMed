...
This function computes the standardized total effects matrix over a
specific time interval \\\Delta t\\ using the first-order stochastic
...
The standardized total effect matrix over a specific time interval
\\\Delta t\\ is given by \$\$ \mathrm{Total}^{\ast}\_{{\Delta t}\_{i,
j}} = \mathrm{Total}\_{{\Delta t}\_{i, j}} \left(
...
#> m  0.3888 0.5999 0.0000
#> y -0.1069 0.5494 0.5001
```
