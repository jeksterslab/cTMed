...
This function computes the standardized total, direct, and indirect
effects of the independent variable \\X\\ on the dependent variable
\\Y\\ through mediator variables \\\mathbf{m}\\ over a specific time
...
``` r
MedStd(phi, sigma, delta_t, from, to, med, tol = 0.001)
```
