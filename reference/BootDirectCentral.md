# Bootstrap Sampling Distribution for the Direct Effect Centrality Over a Specific Time Interval or a Range of Time Intervals
...
``` r
BootDirectCentral(phi, phi_hat, delta_t, ncores = NULL, tol = 0.001)
```
...
- fun:
  ...
  Function used ("BootDirectCentral").
...
- est:
  ...
  A vector of direct effect centrality.

- thetahatstar:

  A matrix of bootstrap direct effect centrality.
...
# Methods -------------------------------------------------------------------
# BootDirectCentral has a number of methods including
