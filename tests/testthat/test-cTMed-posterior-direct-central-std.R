## ---- test-cTMed-posterior-direct-central-std
lapply(
  X = 1,
  FUN = function(i,
                 text,
    ...
    testthat::test_that(
      paste(text, "PosteriorDirectCentralStd"),
      {
        ...
        output <- PosteriorDirectCentralStd(
          phi = phi_post,
          sigma = sigma_post,
          delta_t = 1:2
        )
  ...
  text = "test-cTMed-posterior-direct-central-std",
  tol = 0.01
)
