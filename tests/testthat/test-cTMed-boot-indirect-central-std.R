## ---- test-cTMed-boot-indirect-central-std
lapply(
  X = 1,
  FUN = function(i,
                 text,
    ...
    testthat::test_that(
      paste(text, "BootIndirectCentralStd"),
      {
        ...
        testthat::expect_s3_class(output, "ctmedboot")
  ...
  text = "test-cTMed-boot-indirect-central-std",
  tol = 0.01
)
