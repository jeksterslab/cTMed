...
#' of Standardized Indirect Effect Centrality
...
#'
#' @inheritParams MCIndirectCentral
...
#'     \item{fun}{Function used ("MCIndirectCentralStd").}
...
#' @export
MCIndirectCentralStd <- function(phi,
                                 sigma,
                                 vcov_theta,
                                 delta_t,
                                 R,
