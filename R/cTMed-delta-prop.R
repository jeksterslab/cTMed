...
#' for the Proportion of the Direct and Indirect Effects of X on Y
#' Through M
...
#' for the proportion of the direct, and indirect effects
...
#'   of class `ctesdelta` which is a list with the following elements:
#'   \describe{
#'     \item{call}{Function call.}
#'     \item{args}{Function arguments.}
#'     \item{fun}{Function used ("DeltaProp").}
...
#'     \item{est}{Estimated proportion of the direct and indirect effects.}
#'     \item{vcov}{Sampling variance-covariance matrix of the
#'     proportion of the direct and indirect effects.}
#'   }
#'
#' @examples
#' phi <- matrix(
...
#'
#' # Methods -------------------------------------------------------------------
#' # DeltaProp has a number of methods including
