...
#' of Standardized Total Effect Centrality
...
#'     \item{fun}{Function used ("MCTotalCentralStd").}
...
#' @export
MCTotalCentralStd <- function(phi,
                              sigma,
                              vcov_theta,
                              delta_t,
                              R,
