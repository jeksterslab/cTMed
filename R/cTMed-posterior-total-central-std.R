...
#' of the Standardized Total Effect Centrality
...
#'
#' @inheritParams PosteriorTotalCentral
#' @param sigma List of numeric matrices. Each element is a posterior draw
#'   of the diffusion covariance matrix.
#'
...
#'     \item{fun}{Function used ("PosteriorTotalCentralStd").}
...
#'     standardized total effect centrality measure.}
#'   }
#'
#' @examples
#' set.seed(42)
...
#' @export
PosteriorTotalCentralStd <- function(phi,
                                     sigma,
                                     delta_t,
                                     ncores = NULL,
                                     tol = 0.001) {
