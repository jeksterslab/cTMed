...
#'
#' @inheritParams BootIndirectCentral
...
#'     \item{fun}{Function used ("BootIndirectCentralStd").}
#'     \item{output}{A list of length `length(delta_t)`.}
#'   }
#'   Each element in the `output` list has the following elements:
#'   \describe{
#'     \item{est}{A vector of standardized indirect effect centrality.}
...
#'
#' # Methods -------------------------------------------------------------------
#' # BootIndirectCentralStd has a number of methods including
...
#' @export
BootIndirectCentralStd <- function(phi,
                                   sigma,
                                   phi_hat,
                                   sigma_hat,
                                   delta_t,
