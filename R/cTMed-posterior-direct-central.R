...
#' of the Direct Effect Centrality
...
#'     \item{fun}{Function used ("PosteriorDirectCentral").}
...
#'     of the total, direct, and direct effects.}
#'     \item{thetahatstar}{Posterior distribution of the
#'     total, direct, and direct effects.}
#'   }
#'
#' @examples
#' phi <- matrix(
