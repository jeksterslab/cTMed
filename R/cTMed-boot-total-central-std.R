...
#'
#' @inheritParams BootTotalCentral
...
#'     \item{fun}{Function used ("BootTotalCentralStd").}
#'     \item{output}{A list of length `length(delta_t)`.}
#'   }
#'   Each element in the `output` list has the following elements:
#'   \describe{
#'     \item{est}{A vector of standardized total effect centrality.}
...
#' @export
BootTotalCentralStd <- function(phi,
                                sigma,
                                phi_hat,
                                sigma_hat,
                                delta_t,
