...
.DirectCentrals <- function(phi, delta_t) {
...
.DirectCentral <- function(phi, delta_t) {
    .Call(`_cTMed_DirectCentral`, phi, delta_t)
}
...
.MCPhiSigmaI <- function(theta, vcov_theta, test_phi = TRUE, sigma_diag = FALSE) {
    .Call(`_cTMed_MCPhiSigmaI`, theta, vcov_theta, test_phi, sigma_diag)
}

.MCPhiSigma <- function(theta, vcov_theta, R, test_phi = TRUE, sigma_diag = FALSE) {
    .Call(`_cTMed_MCPhiSigma`, theta, vcov_theta, R, test_phi, sigma_diag)
}
