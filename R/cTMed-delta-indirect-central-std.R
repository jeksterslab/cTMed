...
#' for the Standardized Indirect Effect Centrality
...
#'
#' @inheritParams DeltaIndirectCentral
...
#'     \item{fun}{Function used ("DeltaIndirectCentralStd").}
...
#'     \item{est}{Estimated standardized indirect effect centrality.}
...
#' @export
DeltaIndirectCentralStd <- function(phi,
                                    sigma,
                                    vcov_theta,
                                    delta_t,
                                    sigma_diag = FALSE,
