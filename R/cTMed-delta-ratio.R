...
#' for the Ratio of the Direct and Indirect Effects of X on Y
#' Through M
...
#' for the ratio of the direct, and indirect effects
...
#'     \item{fun}{Function used ("DeltaRatio").}
...
#'     \item{est}{Estimated ratio of the direct and indirect effects.}
#'     \item{vcov}{Sampling variance-covariance matrix of the
#'     ratio of the direct and indirect effects.}
#'   }
#'
#' @examples
#' phi <- matrix(
...
#'
#' # Methods -------------------------------------------------------------------
#' # DeltaRatio has a number of methods including
