...
#' of Standardized Direct Effect Centrality
...
#'     \item{fun}{Function used ("MCDirectCentralStd").}
...
#' @export
MCDirectCentralStd <- function(phi,
                               sigma,
                               vcov_theta,
                               delta_t,
                               R,
