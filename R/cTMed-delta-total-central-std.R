...
#' for the Standardized Total Effect Centrality
...
#'
#' @details See [TotalCentralStd()] for more details.
#'
#' ## Delta Method
...
#'
#' @inheritParams DeltaTotalCentral
...
#'     \item{fun}{Function used ("DeltaTotalCentralStd").}
...
#'     \item{est}{Estimated standardized total effect centrality.}
...
#' @export
DeltaTotalCentralStd <- function(phi,
                                 sigma,
                                 vcov_theta,
                                 delta_t,
                                 sigma_diag = FALSE,
