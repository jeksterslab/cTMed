...
#> [1] cTMed_1.0.3.9000         OpenMx_2.21.13           dynr_0.1.16-109         
#> [4] ggplot2_3.5.1            simStateSpace_1.2.3.9000
#> 
...
#> [13] tibble_3.2.1        cluster_2.1.6       pan_1.9            
#> [16] pkgconfig_2.0.3     fds_1.8             jomo_2.7-6         
#> [19] Matrix_1.7-0        KernSmooth_2.23-24  RcppParallel_5.1.9 
...
#> [34] car_3.1-3           pillar_1.10.0       nloptr_2.1.1       
#> [37] tidyr_1.3.1         MASS_7.3-60.2       iterators_1.0.14   
#> [40] abind_1.4-8         rpart_4.1.23        boot_1.3-30        
#> [43] rProject_0.0.14     mclust_6.1.1        foreach_1.5.2      
#> [46] mitml_0.4-5         nlme_3.1-164        digest_0.6.37      
#> [49] tidyselect_1.2.1    mvtnorm_1.3-2       stringi_1.8.4      
#> [52] dplyr_1.1.4         reshape2_1.4.4      purrr_1.0.2        
#> [55] splines_4.4.1       pcaPP_2.0-5         latex2exp_0.9.6    
#> [58] grid_4.4.1          colorspace_2.1-1    expm_1.0-0         
#> [61] cli_3.6.3.9001      magrittr_2.0.3      survival_3.6-4     
#> [64] broom_1.0.7         withr_3.0.2         scales_1.3.0       
#> [67] backports_1.5.0     nnet_7.3-19         lme4_1.1-35.5      
#> [70] deSolve_1.40        evaluate_1.0.1      knitr_1.49         
#> [73] rbibutils_2.3       rlang_1.1.4         Rcpp_1.0.13-1      
...
#> Mem:            23Gi       7.0Gi       1.6Gi       1.3Gi        14Gi        14Gi
#> Swap:           11Gi       2.0Mi        11Gi
#> Total:          34Gi       7.0Gi        13Gi
```
