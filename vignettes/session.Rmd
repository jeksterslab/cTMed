...
#> [1] cTMed_1.0.8.9000          bootStateSpace_1.0.3     
#> [3] OpenMx_2.22.9             dynr_0.1.16-114          
#> [5] ggplot2_4.0.0             simStateSpace_1.2.12.9000
#> 
...
#> [10] digest_0.6.37         rpart_4.1.24          lifecycle_1.0.4      
#> [13] cluster_2.1.8.1       survival_3.8-3        magrittr_2.0.4       
#> [16] compiler_4.5.1        rlang_1.1.6           tools_4.5.1          
#> [19] rProject_0.0.21       knitr_1.50            mclust_6.1.1         
#> [22] plyr_1.8.9            RColorBrewer_1.1-3    rainbow_3.8          
#> [25] abind_1.4-8           KernSmooth_2.23-26    fda_6.3.0            
#> [28] expm_1.0-0            withr_3.0.2           purrr_1.1.0          
#> [31] numDeriv_2016.8-1.1   nnet_7.3-20           grid_4.5.1           
#> [34] pcaPP_2.0-5           jomo_2.7-6            xtable_1.8-4         
#> [37] colorspace_2.1-2      mice_3.18.0           scales_1.4.0         
#> [40] iterators_1.0.14      MASS_7.3-65           cli_3.6.5.9000       
#> [43] mvtnorm_1.3-3         reformulas_0.4.1      generics_0.1.4       
#> [46] RcppParallel_5.1.11-1 reshape2_1.4.4        fds_1.8              
#> [49] minqa_1.2.8           stringr_1.5.2         splines_4.5.1        
#> [52] parallel_4.5.1        vctrs_0.6.5           boot_1.3-31          
#> [55] glmnet_4.1-10         Matrix_1.7-3          carData_3.0-5        
#> [58] car_3.1-3             mitml_0.4-5           Formula_1.2-5        
...
#> [70] lme4_1.1-37           tibble_3.3.0          pillar_1.11.1        
#> [73] deSolve_1.40          R6_2.6.1              Rdpack_2.6.4         
#> [76] ks_1.15.1             evaluate_1.0.5        lattice_0.22-7       
#> [79] rbibutils_2.3         backports_1.5.0       broom_1.0.10         
#> [82] Rcpp_1.1.0            nlme_3.1-168          xfun_0.53            
#> [85] pkgconfig_2.0.3
```
...
#> Mem:           251Gi        12Gi        72Gi       5.5Gi       174Gi       239Gi
#> Swap:             0B          0B          0B
#> Total:         251Gi        12Gi        72Gi
```
