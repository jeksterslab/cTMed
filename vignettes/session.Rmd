...
#> [1] cTMed_1.0.6.9000          bootStateSpace_1.0.1.9000
#> [3] dynr_0.1.16-109           ggplot2_3.5.1            
#> [5] simStateSpace_1.2.8.9000 
#> 
...
#> [19] Matrix_1.7-1        KernSmooth_2.23-24  lifecycle_1.0.4    
#> [22] compiler_4.4.2      stringr_1.5.1       munsell_0.5.1      
#> [25] codetools_0.2-20    carData_3.0-5       rainbow_3.8        
#> [28] RCurl_1.98-1.16     glmnet_4.1-8        Formula_1.2-5      
#> [31] pracma_2.4.4        mice_3.17.0         car_3.1-3          
#> [34] pillar_1.10.1       nloptr_2.1.1        tidyr_1.3.1        
#> [37] MASS_7.3-61         reformulas_0.4.0    iterators_1.0.14   
#> [40] abind_1.4-8         rpart_4.1.23        boot_1.3-31        
#> [43] rProject_0.0.18     mclust_6.1.1        foreach_1.5.2      
#> [46] mitml_0.4-5         nlme_3.1-166        tidyselect_1.2.1   
#> [49] mvtnorm_1.3-3       stringi_1.8.4       dplyr_1.1.4        
#> [52] reshape2_1.4.4      purrr_1.0.4         splines_4.4.2      
#> [55] pcaPP_2.0-5         latex2exp_0.9.6     grid_4.4.2         
#> [58] colorspace_2.1-1    expm_1.0-0          cli_3.6.3.9002     
...
#> [73] rlang_1.1.5         Rcpp_1.0.14         hdrcde_3.4         
...
#> Mem:           125Gi        11Gi        78Gi       5.3Gi        42Gi       114Gi
#> Swap:             0B          0B          0B
#> Total:         125Gi        11Gi        78Gi
```
