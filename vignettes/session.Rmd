...
#> [1] cTMed_1.0.7          bootStateSpace_1.0.2 dynr_0.1.16-112     
#> [4] ggplot2_3.5.2        simStateSpace_1.2.11
#> 
#> loaded via a namespace (and not attached):
#>  [1] gtable_0.3.6        shape_1.4.6.1       xfun_0.53          
#>  [4] ks_1.15.1           lattice_0.22-7      numDeriv_2016.8-1.1
...
#> [19] Matrix_1.7-3        KernSmooth_2.23-26  RColorBrewer_1.1-3 
#> [22] lifecycle_1.0.4     compiler_4.5.1      farver_2.1.2       
#> [25] stringr_1.5.1       codetools_0.2-20    carData_3.0-5      
#> [28] rainbow_3.8         RCurl_1.98-1.17     glmnet_4.1-10      
#> [31] Formula_1.2-5       mice_3.18.0         pracma_2.4.4       
#> [34] car_3.1-3           pillar_1.11.0       nloptr_2.2.1       
#> [37] tidyr_1.3.1         MASS_7.3-65         reformulas_0.4.1   
#> [40] iterators_1.0.14    abind_1.4-8         rpart_4.1.24       
#> [43] boot_1.3-31         rProject_0.0.21     mclust_6.1.1       
#> [46] foreach_1.5.2       mitml_0.4-5         nlme_3.1-168       
#> [49] tidyselect_1.2.1    mvtnorm_1.3-3       stringi_1.8.7      
#> [52] dplyr_1.1.4         reshape2_1.4.4      purrr_1.1.0        
#> [55] splines_4.5.1       pcaPP_2.0-5         latex2exp_0.9.6    
#> [58] grid_4.5.1          colorspace_2.1-1    expm_1.0-0         
#> [61] cli_3.6.5.9000      magrittr_2.0.3      survival_3.8-3     
#> [64] broom_1.0.9         withr_3.0.2         scales_1.4.0       
#> [67] backports_1.5.0     nnet_7.3-20         lme4_1.1-37        
#> [70] deSolve_1.40        evaluate_1.0.4      knitr_1.50         
#> [73] rbibutils_2.3       rlang_1.1.6         Rcpp_1.1.0         
#> [76] hdrcde_3.4          xtable_1.8-4        glue_1.8.0         
#> [79] fda_6.3.0           minqa_1.2.8         R6_2.6.1           
#> [82] plyr_1.8.9
```
...
#> Mem:           251Gi        12Gi       177Gi       5.6Gi        69Gi       239Gi
#> Swap:             0B          0B          0B
#> Total:         251Gi        12Gi       177Gi
```
