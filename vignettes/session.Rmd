...
#> [1] cTMed_1.0.2              OpenMx_2.21.13           dynr_0.1.16-109         
#> [4] ggplot2_3.5.1            simStateSpace_1.2.2.9000
#> 
#> loaded via a namespace (and not attached):
#>  [1] gtable_0.3.6        shape_1.4.6.1       xfun_0.49          
#>  [4] ks_1.14.3           lattice_0.22-6      numDeriv_2016.8-1.1
#>  [7] bitops_1.0-9        vctrs_0.6.5         tools_4.4.1        
#> [10] Rdpack_2.6.2        generics_0.1.3      parallel_4.4.1     
#> [13] tibble_3.2.1        fansi_1.0.6         cluster_2.1.6      
#> [16] pan_1.9             pkgconfig_2.0.3     fds_1.8            
#> [19] jomo_2.7-6          Matrix_1.7-0        KernSmooth_2.23-24 
#> [22] RcppParallel_5.1.9  lifecycle_1.0.4     compiler_4.4.1     
#> [25] stringr_1.5.1       munsell_0.5.1       codetools_0.2-20   
#> [28] carData_3.0-5       rainbow_3.8         RCurl_1.98-1.16    
#> [31] glmnet_4.1-8        Formula_1.2-5       pracma_2.4.4       
#> [34] mice_3.16.0         car_3.1-3           pillar_1.9.0       
#> [37] nloptr_2.1.1        tidyr_1.3.1         MASS_7.3-60.2      
#> [40] iterators_1.0.14    abind_1.4-8         mclust_6.1.1       
#> [43] rpart_4.1.23        boot_1.3-30         rProject_0.0.14    
#> [46] foreach_1.5.2       mitml_0.4-5         nlme_3.1-164       
#> [49] digest_0.6.37       tidyselect_1.2.1    mvtnorm_1.3-2      
#> [52] stringi_1.8.4       dplyr_1.1.4         reshape2_1.4.4     
#> [55] purrr_1.0.2         splines_4.4.1       pcaPP_2.0-5        
#> [58] latex2exp_0.9.6     grid_4.4.1          colorspace_2.1-1   
#> [61] expm_1.0-0          cli_3.6.3.9001      magrittr_2.0.3     
#> [64] survival_3.6-4      utf8_1.2.4          broom_1.0.7        
#> [67] withr_3.0.2         scales_1.3.0        backports_1.5.0    
#> [70] nnet_7.3-19         lme4_1.1-35.5       deSolve_1.40       
#> [73] evaluate_1.0.1      knitr_1.49          rbibutils_2.3      
#> [76] rlang_1.1.4         Rcpp_1.0.13-1       hdrcde_3.4         
#> [79] xtable_1.8-4        glue_1.8.0          fda_6.2.0          
#> [82] minqa_1.2.8         R6_2.5.1            plyr_1.8.9
```
...
#> Mem:           125Gi       4.1Gi        16Gi       5.1Gi       105Gi       115Gi
#> Swap:             0B          0B          0B
#> Total:         125Gi       4.1Gi        16Gi
```
