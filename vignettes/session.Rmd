...
#> [1] cTMed_1.0.5         dynr_0.1.16-109     ggplot2_3.5.1      
#> [4] simStateSpace_1.2.8
#> 
...
#> [43] rProject_0.0.17     mclust_6.1.1        foreach_1.5.2      
#> [46] mitml_0.4-5         nlme_3.1-166        tidyselect_1.2.1   
#> [49] mvtnorm_1.3-3       stringi_1.8.4       dplyr_1.1.4        
#> [52] reshape2_1.4.4      purrr_1.0.2         splines_4.4.2      
...
#> Mem:            23Gi       5.2Gi       7.2Gi       687Mi        11Gi        17Gi
#> Swap:           11Gi       4.2Mi        11Gi
#> Total:          34Gi       5.2Gi        18Gi
```
