...
#> [1] cTMed_1.0.8          bootStateSpace_1.0.2 dynr_0.1.16-114     
#> [4] ggplot2_4.0.0        simStateSpace_1.2.12
#> 
...
#> [25] farver_2.1.2        stringr_1.5.2       codetools_0.2-20   
#> [28] carData_3.0-5       rainbow_3.8         RCurl_1.98-1.17    
#> [31] glmnet_4.1-10       Formula_1.2-5       pracma_2.4.4       
#> [34] mice_3.18.0         car_3.1-3           pillar_1.11.1      
#> [37] nloptr_2.2.1        tidyr_1.3.1         MASS_7.3-65        
#> [40] reformulas_0.4.1    iterators_1.0.14    abind_1.4-8        
#> [43] rpart_4.1.24        boot_1.3-31         rProject_0.0.21    
#> [46] mclust_6.1.1        foreach_1.5.2       mitml_0.4-5        
#> [49] nlme_3.1-168        tidyselect_1.2.1    mvtnorm_1.3-3      
#> [52] stringi_1.8.7       dplyr_1.1.4         reshape2_1.4.4     
#> [55] purrr_1.1.0         splines_4.5.1       pcaPP_2.0-5        
#> [58] latex2exp_0.9.6     grid_4.5.1          colorspace_2.1-2   
#> [61] expm_1.0-0          cli_3.6.5.9000      magrittr_2.0.4     
#> [64] survival_3.8-3      broom_1.0.10        withr_3.0.2        
#> [67] scales_1.4.0        backports_1.5.0     nnet_7.3-20        
#> [70] lme4_1.1-37         deSolve_1.40        evaluate_1.0.5     
#> [73] knitr_1.50          rbibutils_2.3       rlang_1.1.6        
#> [76] Rcpp_1.1.0          hdrcde_3.4          xtable_1.8-4       
#> [79] glue_1.8.0          fda_6.3.0           minqa_1.2.8        
...
#> Mem:           125Gi        11Gi        57Gi       5.5Gi        63Gi       114Gi
#> Swap:             0B          0B          0B
#> Total:         125Gi        11Gi        57Gi
```
