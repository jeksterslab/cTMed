...
\
`mu0`` ``<-`` `[`mxMatrix`](https://rdrr.io/pkg/OpenMx/man/mxMatrix.html)`(`\
`  type ``=`` ``"Full"``,`\
`  nrow ``=`` ``3``,`\
`  ncol ``=`` ``1``,`\
`  free ``=`` ``TRUE``,`\
`  values ``=`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`\
...
`    ncol ``=`` ``1`\
`  ``)``,`\
`  labels ``=`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`\
`    data ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(`\
...
`    `[`c`](https://rdrr.io/r/base/c.html)`(``"eta_x"``, ``"eta_m"``, ``"eta_y"``)``,`\
`    ``"mu0"`\
`  ``)``,`\
`  name ``=`` ``"mu0"`\
`)`\
`sigma0`` ``<-`` `[`mxMatrix`](https://rdrr.io/pkg/OpenMx/man/mxMatrix.html)`(`\
`  type ``=`` ``"Symm"``,`\
`  nrow ``=`` ``3``,`\
`  ncol ``=`` ``3``,`\
`  free ``=`` ``TRUE``,`\
...
`    ncol ``=`` ``3`\
`  ``)``,`\
`  lbound ``=`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`\
`    data ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(`\
`      ``0``, ``NA``, ``NA``,`\
`      ``NA``, ``0``, ``NA``,`\
`      ``NA``, ``NA``, ``0`\
...
\
`lambda`` ``<-`` `[`mxMatrix`](https://rdrr.io/pkg/OpenMx/man/mxMatrix.html)`(`\
`  type ``=`` ``"Diag"``,`\
`  nrow ``=`` ``3``,`\
`  ncol ``=`` ``3``,`\
`  free ``=`` ``FALSE``,`\
...
`  byrow ``=`` ``FALSE``,`\
`  dimnames ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`\
`    `[`c`](https://rdrr.io/r/base/c.html)`(``"x"``, ``"m"``, ``"y"``)``,`\
`    `[`c`](https://rdrr.io/r/base/c.html)`(``"eta_x"``, ``"eta_m"``, ``"eta_y"``)`\
`  ``)``,`\
`  name ``=`` ``"lambda"`\
`)`
...
\
`phi`` ``<-`` `[`mxMatrix`](https://rdrr.io/pkg/OpenMx/man/mxMatrix.html)`(`\
`  type ``=`` ``"Full"``,`\
`  nrow ``=`` ``3``,`\
`  ncol ``=`` ``3``,`\
`  free ``=`` ``TRUE``,`\
...
\
`sigma`` ``<-`` `[`mxMatrix`](https://rdrr.io/pkg/OpenMx/man/mxMatrix.html)`(`\
`  type ``=`` ``"Symm"``,`\
`  nrow ``=`` ``3``,`\
`  ncol ``=`` ``3``,`\
`  free ``=`` ``TRUE``,`\
`  values ``=`` ``0.2`` ``*`` `[`diag`](https://rdrr.io/pkg/dynr/man/diag-character-method.html)`(``3``)``,`\
`  labels ``=`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`\
`    data ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(`\
...
`  name ``=`` ``"sigma"`\
`)`\
`theta`` ``<-`` `[`mxMatrix`](https://rdrr.io/pkg/OpenMx/man/mxMatrix.html)`(`\
`  type ``=`` ``"Diag"``,`\
`  nrow ``=`` ``3``,`\
`  ncol ``=`` ``3``,`\
`  free ``=`` ``TRUE``,`\
...
\
`time`` ``<-`` `[`mxMatrix`](https://rdrr.io/pkg/OpenMx/man/mxMatrix.html)`(`\
`  type ``=`` ``"Full"``,`\
`  nrow ``=`` ``1``,`\
`  ncol ``=`` ``1``,`\
`  free ``=`` ``FALSE``,`\
...
`  name ``=`` ``"time"`\
`)`\
`gamma`` ``<-`` `[`mxMatrix`](https://rdrr.io/pkg/OpenMx/man/mxMatrix.html)`(`\
`  type ``=`` ``"Zero"``,`\
`  nrow ``=`` ``3``,`\
`  ncol ``=`` ``1``,`\
`  name ``=`` ``"gamma"`\
`)`\
`kappa`` ``<-`` `[`mxMatrix`](https://rdrr.io/pkg/OpenMx/man/mxMatrix.html)`(`\
`  type ``=`` ``"Zero"``,`\
`  nrow ``=`` ``3``,`\
`  ncol ``=`` ``1``,`\
`  name ``=`` ``"kappa"`\
`)`\
`covariate`` ``<-`` `[`mxMatrix`](https://rdrr.io/pkg/OpenMx/man/mxMatrix.html)`(`\
`  type ``=`` ``"Zero"``,`\
`  nrow ``=`` ``1``,`\
`  ncol ``=`` ``1``,`\
`  name ``=`` ``"covariate"`\
...
\
`model`` ``<-`` `[`mxModel`](https://rdrr.io/pkg/OpenMx/man/mxModel.html)`(`\
`  model ``=`` ``"CTVAR"``,`\
`  ``phi``,`\
`  ``gamma``,`\
`  ``lambda``,`\
...
`  ``covariate``,`\
`  ``time``,`\
`  `[`mxExpectationStateSpaceContinuousTime`](https://rdrr.io/pkg/OpenMx/man/mxExpectationStateSpaceContinuousTime.html)`(`\
`    A ``=`` ``"phi"``,`\
`    B ``=`` ``"gamma"``,`\
`    C ``=`` ``"lambda"``,`\
`    D ``=`` ``"kappa"``,`\
...
`    u ``=`` ``"covariate"``,`\
`    t ``=`` ``"time"``,`\
`    dimnames ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"x"``, ``"m"``, ``"y"``)`\
`  ``)``,`\
`  `[`mxFitFunctionML`](https://rdrr.io/pkg/OpenMx/man/mxFitFunctionML.html)`(``)``,`\
`  `[`mxData`](https://rdrr.io/pkg/OpenMx/man/mxData.html)`(`\
`    observed ``=`` ``data``,`\
`    type ``=`` ``"raw"`\
`  ``)`\
`)`\
`ids`` ``<-`` `[`sort`](https://rdrr.io/r/base/sort.html)`(`\
`  `[`unique`](https://rdrr.io/r/base/unique.html)`(``data``[``, ``"id"``]``)`\
`)`\
`model_id`` ``<-`` `[`lapply`](https://rdrr.io/r/base/lapply.html)`(`\
`  X ``=`` ``ids``,`\
`  FUN ``=`` ``function``(``i``,`\
`                 ``data``,`\
`                 ``model``)`` ``{`\
`    `[`return`](https://rdrr.io/r/base/function.html)`(`\
`      `[`mxModel`](https://rdrr.io/pkg/OpenMx/man/mxModel.html)`(`\
`        name ``=`` `[`paste0`](https://rdrr.io/r/base/paste.html)`(``"CTVAR"``, ``"_"``, ``i``)``,`\
`        model ``=`` ``model``,`\
`        `[`mxData`](https://rdrr.io/pkg/OpenMx/man/mxData.html)`(`\
`          observed ``=`` ``data``[`\
...
\
`fit`` ``<-`` `[`mxTryHardctsem`](https://rdrr.io/pkg/OpenMx/man/mxTryHard.html)`(`\
`  model ``=`` `[`mxModel`](https://rdrr.io/pkg/OpenMx/man/mxModel.html)`(`\
`    name ``=`` ``"CTVAR"``,`\
`    ``model_id``,`\
