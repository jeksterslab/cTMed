...
#> [1] cTMed_1.0.8.9000          bootStateSpace_1.0.3.9000
#> [3] OpenMx_2.22.10            dynr_0.1.16-114          
#> [5] ggplot2_4.0.1             simStateSpace_1.2.14.9000
#> 
...
#> [16] compiler_4.5.2        rlang_1.1.7           tools_4.5.2          
#> [19] rProject_0.0.23       knitr_1.51            mclust_6.1.2         
#> [22] plyr_1.8.9            RColorBrewer_1.1-3    rainbow_3.8          
#> [25] abind_1.4-8           KernSmooth_2.23-26    fda_6.3.0            
#> [28] expm_1.0-0            withr_3.0.2           purrr_1.2.1          
#> [31] numDeriv_2016.8-1.1   nnet_7.3-20           grid_4.5.2           
#> [34] pcaPP_2.0-5           jomo_2.7-6            xtable_1.8-4         
#> [37] colorspace_2.1-2      mice_3.19.0           scales_1.4.0         
#> [40] iterators_1.0.14      MASS_7.3-65           cli_3.6.5.9000       
#> [43] mvtnorm_1.3-3         reformulas_0.4.3.1    generics_0.1.4       
#> [46] otel_0.2.0            RcppParallel_5.1.11-1 reshape2_1.4.5       
#> [49] fds_1.8               minqa_1.2.8           stringr_1.6.0        
#> [52] splines_4.5.2         parallel_4.5.2        vctrs_0.7.1          
#> [55] boot_1.3-32           glmnet_4.1-10         Matrix_1.7-4         
#> [58] carData_3.0-6         car_3.1-3             mitml_0.4-5          
#> [61] Formula_1.2-5         foreach_1.5.2         tidyr_1.3.2          
#> [64] glue_1.8.0            nloptr_2.2.1          pan_1.9              
#> [67] codetools_0.2-20      stringi_1.8.7         shape_1.4.6.1        
#> [70] gtable_0.3.6          lme4_1.1-38           tibble_3.3.1         
#> [73] pillar_1.11.1         deSolve_1.40          R6_2.6.1             
#> [76] Rdpack_2.6.5          ks_1.15.1             evaluate_1.0.5       
#> [79] lattice_0.22-7        rbibutils_2.4.1       backports_1.5.0      
#> [82] broom_1.0.12          Rcpp_1.1.1            nlme_3.1-168         
...
## Memory
    ...
    #> Mem:            44Gi       4.7Gi        26Gi        14Mi        13Gi        39Gi
    #> Swap:           22Gi          0B        22Gi
    #> Total:          66Gi       4.7Gi        49Gi
