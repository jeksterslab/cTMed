...
#> [5] ggplot2_4.0.1             simStateSpace_1.2.12.9001
#> 
...
#> [28] expm_1.0-0            withr_3.0.2           purrr_1.2.0          
...
#> [43] mvtnorm_1.3-3         reformulas_0.4.3      generics_0.1.4       
#> [46] otel_0.2.0            RcppParallel_5.1.11-1 reshape2_1.4.5       
#> [49] fds_1.8               minqa_1.2.8           stringr_1.6.0        
#> [52] splines_4.5.2         parallel_4.5.2        vctrs_0.6.5          
#> [55] boot_1.3-32           glmnet_4.1-10         Matrix_1.7-4         
#> [58] carData_3.0-5         car_3.1-3             mitml_0.4-5          
...
#> [70] gtable_0.3.6          lme4_1.1-38           tibble_3.3.0         
#> [73] pillar_1.11.1         deSolve_1.40          R6_2.6.1             
#> [76] Rdpack_2.6.4          ks_1.15.1             evaluate_1.0.5       
#> [79] lattice_0.22-7        rbibutils_2.4         backports_1.5.0      
#> [82] broom_1.0.11          Rcpp_1.1.0            nlme_3.1-168         
#> [85] xfun_0.55             pkgconfig_2.0.3
```
...
## Memory
    ...
    #> Mem:            44Gi       6.1Gi        27Gi        12Mi        11Gi        38Gi
    #> Swap:           31Gi        54Mi        31Gi
    #> Total:          76Gi       6.2Gi        59Gi
