...
`theta`` ``<-`` `[`diag`](https://rdrr.io/pkg/dynr/man/diag-character-method.html)`(``3``)`\
[`diag`](https://rdrr.io/pkg/dynr/man/diag-character-method.html)`(``theta``)`` ``<-`` ``est``[`\
`  `[`c`](https://rdrr.io/r/base/c.html)`(`\
`    ``"theta_1_1"``,`\
`    ``"theta_2_2"``,`\
`    ``"theta_3_3"`\
...
`boot`` ``<-`` `[`BootMed`](https://github.com/jeksterslab/cTMed/reference/BootMed.md)`(`\
`  phi ``=`` ``phi``,`\
`  phi_hat ``=`` ``phi_hat``,`\
`  delta_t ``=`` ``delta_t``,`\
`  from ``=`` ``"x"``,`\
...
\
`boot`` ``<-`` `[`BootMedStd`](https://github.com/jeksterslab/cTMed/reference/BootMedStd.md)`(`\
`  phi ``=`` ``phi``,`\
`  sigma ``=`` ``sigma``,`\
`  phi_hat ``=`` ``phi_hat``,`\
`  sigma_hat ``=`` ``sigma_hat``,`\
