...
`# estimated process noise covariance matrix`` ``sigma_hat`` ``<-`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`` `` data ``=`` ``est``[`` `` `[`c`](https://rdrr.io/r/base/c.html)`(`` `` ``"sigma_1_1"``, ``"sigma_2_1"``, ``"sigma_3_1"``,`` `` ``"sigma_2_1"``, ``"sigma_2_2"``, ``"sigma_3_2"``,`` `` ``"sigma_3_1"``, ``"sigma_3_2"``, ``"sigma_3_3"`` `` ``)`` `` ``]``,`` `` nrow ``=`` ``3``,`` `` ncol ``=`` ``3`` ``)`` `[`colnames`](https://rdrr.io/r/base/colnames.html)`(``sigma_hat``)`` ``<-`` `[`rownames`](https://rdrr.io/r/base/colnames.html)`(``sigma_hat``)`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``"x"``, ``"m"``, ``"y"``)`
...
[`library`](https://rdrr.io/r/base/library.html)`(`[`cTMed`](https://github.com/jeksterslab/cTMed)`)`` ``boot_total`` ``<-`` `[`BootTotalCentral`](https://github.com/jeksterslab/cTMed/reference/BootTotalCentral.md)`(`` `` phi ``=`` ``phi``,`` `` phi_hat ``=`` ``phi_hat``,`` `` delta_t ``=`` ``delta_t``,`` `` ncores ``=`` ``parallel``::`[`detectCores`](https://rdrr.io/r/parallel/detectCores.html)`(``)`` ``# use multiple cores`` ``)`
...
`boot_indirect`` ``<-`` `[`BootIndirectCentral`](https://github.com/jeksterslab/cTMed/reference/BootIndirectCentral.md)`(`` `` phi ``=`` ``phi``,`` `` phi_hat ``=`` ``phi_hat``,`` `` delta_t ``=`` ``delta_t``,`` `` ncores ``=`` ``parallel``::`[`detectCores`](https://rdrr.io/r/parallel/detectCores.html)`(``)`` ``# use multiple cores`` ``)`
...
`boot_total_std`` ``<-`` `[`BootTotalCentralStd`](https://github.com/jeksterslab/cTMed/reference/BootTotalCentralStd.md)`(`` `` phi ``=`` ``phi``,`` `` sigma ``=`` ``sigma``,`` `` phi_hat ``=`` ``phi_hat``,`` `` sigma_hat ``=`` ``sigma_hat``,`` `` delta_t ``=`` ``delta_t``,`` `` ncores ``=`` ``parallel``::`[`detectCores`](https://rdrr.io/r/parallel/detectCores.html)`(``)`` ``# use multiple cores`` ``)`
...
`boot_indirect_std`` ``<-`` `[`BootIndirectCentralStd`](https://github.com/jeksterslab/cTMed/reference/BootIndirectCentralStd.md)`(`` `` phi ``=`` ``phi``,`` `` sigma ``=`` ``sigma``,`` `` phi_hat ``=`` ``phi_hat``,`` `` sigma_hat ``=`` ``sigma_hat``,`` `` delta_t ``=`` ``delta_t``,`` `` ncores ``=`` ``parallel``::`[`detectCores`](https://rdrr.io/r/parallel/detectCores.html)`(``)`` ``# use multiple cores`` ``)`
