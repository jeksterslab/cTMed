# Total and Indirect Effect Centrality in Continuous-Time Mediation Model (Bootstrap)
...
uncertainty in total and indirect effect centrality within
continuous-time mediation models across different time intervals. This
vignette shows both unstandardized and standardized effect centrality
using bootstrap samples of the drift matrix and, for standardized
centrality, the process noise covariance matrix.
...
\
`est`` ``<-`` `[`coef`](https://rdrr.io/r/stats/coef.html)`(``fit``)`\
`n`\
`#> [1] 100`\
`time`\
`#> [1] 1000`\
...
`sigma0`` ``<-`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`\
`  data ``=`` ``est``[`\
`    `[`c`](https://rdrr.io/r/base/c.html)`(`\
`      ``"sigma0_1_1"``,`\
`      ``"sigma0_2_1"``,`\
...
`sigma0_l`` ``<-`` `[`t`](https://rdrr.io/r/base/t.html)`(`[`chol`](https://rdrr.io/r/base/chol.html)`(``sigma0``)``)`\
`phi`` ``<-`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`\
`  data ``=`` ``est``[`\
`    `[`c`](https://rdrr.io/r/base/c.html)`(`\
`      ``"phi_1_1"``,`\
`      ``"phi_2_1"``,`\
...
`sigma`` ``<-`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`\
`  data ``=`` ``est``[`\
`    `[`c`](https://rdrr.io/r/base/c.html)`(`\
...
`sigma_l`` ``<-`` `[`t`](https://rdrr.io/r/base/t.html)`(`[`chol`](https://rdrr.io/r/base/chol.html)`(``sigma``)``)`\
`theta`` ``<-`` `[`diag`](https://rdrr.io/r/base/diag.html)`(``3``)`\
[`diag`](https://rdrr.io/r/base/diag.html)`(``theta``)`` ``<-`` ``est``[`\
`  `[`c`](https://rdrr.io/r/base/c.html)`(`\
`    ``"theta_1_1"``,`\
`    ``"theta_2_2"``,`\
`    ``"theta_3_3"`\
...
`theta_l`` ``<-`` `[`t`](https://rdrr.io/r/base/t.html)`(`[`chol`](https://rdrr.io/r/base/chol.html)`(``theta``)``)`
...
\
[`library`](https://rdrr.io/r/base/library.html)`(`[`bootStateSpace`](https://github.com/jeksterslab/bootStateSpace)`)`\
`boot`` ``<-`` `[`PBSSMOUFixed`](https://github.com/jeksterslab/bootStateSpace/reference/PBSSMOUFixed.html)`(`\
`  R ``=`` ``R``,`\
`  path ``=`` ``path``,`\
`  prefix ``=`` ``prefix``,`\
`  n ``=`` ``n``,`\
...
\
`# time intervals`\
`delta_t`` ``<-`` `[`seq`](https://rdrr.io/r/base/seq.html)`(``from ``=`` ``0``, to ``=`` ``10``, length.out ``=`` ``1000``)`

We also need the estimated drift matrix from the original sample.

\
`# estimated drift matrix`\
`phi_hat`` ``<-`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`\
`  data ``=`` ``est``[`\
`    `[`c`](https://rdrr.io/r/base/c.html)`(`\
`      ``"phi_1_1"``,`\
`      ``"phi_2_1"``,`\
...
`  ncol ``=`` ``3`\
`)`\
[`colnames`](https://rdrr.io/r/base/colnames.html)`(``phi_hat``)`` ``<-`` `[`rownames`](https://rdrr.io/r/base/colnames.html)`(``phi_hat``)`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``"x"``, ``"m"``, ``"y"``)`

For the standardized centrality estimates, the estimated process noise
covariance matrix from the original sample is also needed.

\
`# estimated process noise covariance matrix`\
`sigma_hat`` ``<-`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`\
`  data ``=`` ``est``[`\
`    `[`c`](https://rdrr.io/r/base/c.html)`(`\
`      ``"sigma_1_1"``, ``"sigma_2_1"``, ``"sigma_3_1"``,`\
`      ``"sigma_2_1"``, ``"sigma_2_2"``, ``"sigma_3_2"``,`\
...
`  ncol ``=`` ``3`\
`)`\
[`colnames`](https://rdrr.io/r/base/colnames.html)`(``sigma_hat``)`` ``<-`` `[`rownames`](https://rdrr.io/r/base/colnames.html)`(``sigma_hat``)`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``"x"``, ``"m"``, ``"y"``)`

## Bootstrap Method: Unstandardized Centrality

The following code generates bootstrap confidence intervals for the
unstandardized total effect centrality.

\
[`library`](https://rdrr.io/r/base/library.html)`(`[`cTMed`](https://github.com/jeksterslab/cTMed)`)`\
`boot_total`` ``<-`` `[`BootTotalCentral`](https://github.com/jeksterslab/cTMed/reference/BootTotalCentral.md)`(`\
`  phi ``=`` ``phi``,`\
`  phi_hat ``=`` ``phi_hat``,`\
`  delta_t ``=`` ``delta_t``,`\
`  ncores ``=`` ``parallel``::`[`detectCores`](https://rdrr.io/r/parallel/detectCores.html)`(``)`` ``# use multiple cores`\
`)`

\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``boot_total``)`

![](fig-vignettes-centrality-boot-boot-total-central-1.png)![](fig-vignettes-centrality-boot-boot-total-central-2.png)![](fig-vignettes-centrality-boot-boot-total-central-3.png)

\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``boot_total``, type ``=`` ``"bc"``)`

![](fig-vignettes-centrality-boot-boot-total-central-4.png)![](fig-vignettes-centrality-boot-boot-total-central-5.png)![](fig-vignettes-centrality-boot-boot-total-central-6.png)

The following code generates bootstrap confidence intervals for the
unstandardized indirect effect centrality.

\
`boot_indirect`` ``<-`` `[`BootIndirectCentral`](https://github.com/jeksterslab/cTMed/reference/BootIndirectCentral.md)`(`\
`  phi ``=`` ``phi``,`\
`  phi_hat ``=`` ``phi_hat``,`\
`  delta_t ``=`` ``delta_t``,`\
`  ncores ``=`` ``parallel``::`[`detectCores`](https://rdrr.io/r/parallel/detectCores.html)`(``)`` ``# use multiple cores`\
...
\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``boot_indirect``)`

![](fig-vignettes-centrality-boot-boot-indirect-central-1.png)![](fig-vignettes-centrality-boot-boot-indirect-central-2.png)![](fig-vignettes-centrality-boot-boot-indirect-central-3.png)

\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``boot_indirect``, type ``=`` ``"bc"``)`

![](fig-vignettes-centrality-boot-boot-indirect-central-4.png)![](fig-vignettes-centrality-boot-boot-indirect-central-5.png)![](fig-vignettes-centrality-boot-boot-indirect-central-6.png)
...
\
`boot_total_std`` ``<-`` `[`BootTotalCentralStd`](https://github.com/jeksterslab/cTMed/reference/BootTotalCentralStd.md)`(`\
`  phi ``=`` ``phi``,`\
`  sigma ``=`` ``sigma``,`\
`  phi_hat ``=`` ``phi_hat``,`\
`  sigma_hat ``=`` ``sigma_hat``,`\
...
\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``boot_total_std``)`

![](fig-vignettes-centrality-boot-boot-total-central-std-1.png)![](fig-vignettes-centrality-boot-boot-total-central-std-2.png)![](fig-vignettes-centrality-boot-boot-total-central-std-3.png)

\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``boot_total_std``, type ``=`` ``"bc"``)`

![](fig-vignettes-centrality-boot-boot-total-central-std-4.png)![](fig-vignettes-centrality-boot-boot-total-central-std-5.png)![](fig-vignettes-centrality-boot-boot-total-central-std-6.png)

The following code generates bootstrap confidence intervals for the
standardized indirect effect centrality.

\
`boot_indirect_std`` ``<-`` `[`BootIndirectCentralStd`](https://github.com/jeksterslab/cTMed/reference/BootIndirectCentralStd.md)`(`\
`  phi ``=`` ``phi``,`\
`  sigma ``=`` ``sigma``,`\
`  phi_hat ``=`` ``phi_hat``,`\
`  sigma_hat ``=`` ``sigma_hat``,`\
...
\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``boot_indirect_std``)`

![](fig-vignettes-centrality-boot-boot-indirect-central-std-1.png)![](fig-vignettes-centrality-boot-boot-indirect-central-std-2.png)![](fig-vignettes-centrality-boot-boot-indirect-central-std-3.png)

\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``boot_indirect_std``, type ``=`` ``"bc"``)`

![](fig-vignettes-centrality-boot-boot-indirect-central-std-4.png)![](fig-vignettes-centrality-boot-boot-indirect-central-std-5.png)![](fig-vignettes-centrality-boot-boot-indirect-central-std-6.png)
