...
\
`phi_varnames`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(`\
`  ``"phi_1_1"``,`\
`  ``"phi_2_1"``,`\
`  ``"phi_3_1"``,`\
`  ``"phi_1_2"``,`\
...
`  data ``=`` `[`coef`](https://rdrr.io/r/stats/coef.html)`(``fit``)``[``phi_varnames``]``,`\
`  nrow ``=`` ``3``,`\
`  ncol ``=`` ``3`\
`)`\
[`colnames`](https://rdrr.io/r/base/colnames.html)`(``phi``)`` ``<-`` `[`rownames`](https://rdrr.io/r/base/colnames.html)`(``phi``)`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``"x"``, ``"m"``, ``"y"``)`\
`sigma_varnames`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(`\
`  ``"sigma_1_1"``, ``"sigma_2_1"``, ``"sigma_3_1"``,`\
`  ``"sigma_2_1"``, ``"sigma_2_2"``, ``"sigma_3_2"``,`\
`  ``"sigma_3_1"``, ``"sigma_3_2"``, ``"sigma_3_3"`\
`)`\
`sigma`` ``<-`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`\
`  data ``=`` `[`coef`](https://rdrr.io/r/stats/coef.html)`(``fit``)``[``sigma_varnames``]``,`\
`  nrow ``=`` ``3``,`\
`  ncol ``=`` ``3`\
`)`\
`theta_varnames`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(`\
`  ``phi_varnames``,`\
`  ``"sigma_1_1"``, ``"sigma_2_1"``, ``"sigma_3_1"``,`\
`  ``"sigma_2_2"``, ``"sigma_3_2"``,`\
`  ``"sigma_3_3"`\
`)`\
`vcov_theta`` ``<-`` `[`vcov`](https://rdrr.io/r/stats/vcov.html)`(``fit``)``[``theta_varnames``, ``theta_varnames``]`
...
`start`` ``<-`` `[`Sys.time`](https://rdrr.io/r/base/Sys.time.html)`(``)`\
`delta`` ``<-`` `[`DeltaMedStd`](https://github.com/jeksterslab/cTMed/reference/DeltaMedStd.md)`(`\
`  phi ``=`` ``phi``,`\
`  sigma ``=`` ``sigma``,`\
...
`)`\
`end`` ``<-`` `[`Sys.time`](https://rdrr.io/r/base/Sys.time.html)`(``)`\
`elapsed`` ``<-`` ``end`` ``-`` ``start`\
`elapsed`\
`#> Time difference of 0.8854623 secs`
...
\
`start`` ``<-`` `[`Sys.time`](https://rdrr.io/r/base/Sys.time.html)`(``)`\
`mc`` ``<-`` `[`MCMedStd`](https://github.com/jeksterslab/cTMed/reference/MCMedStd.md)`(`\
`  phi ``=`` ``phi``,`\
`  sigma ``=`` ``sigma``,`\
`  vcov_theta ``=`` ``vcov_theta``,`\
`  delta_t ``=`` ``delta_t``,`\
...
`elapsed`` ``<-`` ``end`` ``-`` ``start`\
`elapsed`\
`#> Time difference of 16.72777 mins`
